...
![three-way venn diagram with affect, behavior, and cognition; all inside social and cultural context]({{github.com/plonskipe/plonskipe.github.io/blob/main}}/assets/abccs.png)
{: refdef}
